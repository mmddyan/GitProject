...
from Git_repodemo.histories_project.POM.Pages.Christmas_start_page import ChristmasStartPageHeader
from Git_repodemo.histories_project.POM.Pages.Home_page import HomePage
from Git_repodemo.histories_project.POM.Pages.Saturnalia_page import SaturnaliaPage
...
def get_driver(request, get_browser):
    ...
    request.cls.christmasstartpage = ChristmasStartPageHeader(driver)
    request.cls.saturnaliapage = SaturnaliaPage(driver)
